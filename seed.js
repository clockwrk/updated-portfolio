...
let projects = [
    { 'deploy': 'http://joserenteria.nyc', 'description': 'This project is the website that you are currently viewing. I built this dynamic portfolio to showcase my best qualities', 'gitHub': 'https://github.com/clockwrk/portfolio', 'name': 'Portfolio', 'techList': ' Javascript, HTML, CSS, Angular, PostgreSQL, Heroku', 'imageUrl': '/asset/Portfolio-min.png', 'videoLink': '' },
    { 'deploy': 'https://markey.herokuapp.com/', 'description': ' This is an e-commerce site that simulates buying tickets to concerts', 'gitHub': 'https://github.com/gewl/markey', 'name': 'Markey', 'techList': ' Javascript, HTML, CSS, Angular, PostgreSQL, Heroku, REST API', 'imageUrl': '/asset/Markey-min.png', 'videoLink': '' },
    { 'deploy': 'https://radiant-cliffs-28831.herokuapp.com', 'description': 'This was my capstone team project at Fullstack Academy. You use Imvue to creat an art project from a android device and save it to a specific geolocation.', 'gitHub': 'https://github.com/clockwrk/ImVue', 'name': 'ImVue', 'techList': ' video camera, gyroscope, GPS, Google Maps API ,Javascript, HTML, CSS, Angular, PostgreSQL, Heroku, REST API', 'imageUrl': '/asset/ImVue-min.png', 'videoLink': 'https://www.youtube.com/embed/5ak0x3pe30A' }
]
db.sync({ force: true })
    .then(function() {
